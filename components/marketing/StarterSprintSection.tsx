...
/**
 * Starter Sprint — the paid pilot rung between free samples and monthly plans.
 * One-time, fixed-scope: $950, 15 assets, 7 days, credited toward month one.
 */
export function StarterSprintSection() {
  const BULLETS = [
    ...
    <section id="sprint" className="px-6 py-20 scroll-mt-20">
      <div className="mx-auto grid max-w-5xl items-center gap-10 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-4 max-w-xl text-[15px] leading-relaxed text-[#A9A092]">
            The Starter Sprint is a one-time, fixed-scope engagement: send us your property photos,
            menus, and event details, and within 7 days you&apos;ll have 15 finished, approval-ready
            assets — social graphics, promos, and captions, built on your brand. No contract, no
            onboarding project, no monthly commitment.
          </p>
        </div>
        ...
        >
          <h3 className="font-serif text-xl text-[#F6F1E7]">Starter Sprint</h3>
          <div className="mt-2 font-serif text-3xl text-[#C9A44C]">
            $950 <span className="text-base text-[#A9A092]">— one-time</span>
          </div>
          <ul className="mt-5 space-y-2.5 text-[14.5px] text-[#A9A092]">
            {BULLETS.map((b) => (
