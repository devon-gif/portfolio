...
export const SPRINT_DAYS: SprintDayPlan[] = [
  ...
  },
  {
    ...
    contentTheme: "Proof",
    postHook: "13.9M+ impressions later, here's what I've learned about hospitality creative.",
    postBody:
      "Across hotel, F&B, spa, and event clients: consistency beats virality, F&B out-engages rooms, motion beats stills, and the properties that win treat creative as a system, not a task. 13.9M+ impressions, 543K+ engagements, 3.6M+ reach — all built from assets the properties already had.",
    ...
    suggestedHeadline: "13.9M+ impressions. Zero new photo shoots.",
