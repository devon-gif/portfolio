...
const ELAINE: CheckoutOffer = {
  ...
  subtitle:
    "Choose a monthly package, then choose how many active properties or brands to include. Final monthly billing equals the selected per-property rate multiplied by the number of participating properties or brands.",
  ...
  plans: [
    {
      ...
      maxProperties: 3,
      features: [
        "4–6 finished creative assets per property / brand each month",
    ...
    },
    {
      ...
      badge: "Recommended",
      features: [
        "8–10 finished creative assets per property / brand each month",
    ...
    },
    {
      ...
      maxProperties: 6,
      features: [
        "12–16 finished creative assets per property / brand each month",
